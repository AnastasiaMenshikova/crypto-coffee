  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <h1 className={styles.title}>Buy Madi a Coffee!</h1>
        ...
        {currentAccount ? (
          <div>
            <form>
              ...
              <br />
              <div className="formgroup">
                <label>Send Madi a message</label>
                <br />
      ...
      <footer className={styles.footer}>
        <a
          href="https://twitter.com/Madi_LaCroix"
          target="_blank"
          rel="noopener noreferrer"
        >
          Created by @Madi_LaCroix for Alchemy's Road to Web3 lesson two!
        </a>
      </footer>
    </div>
  );
